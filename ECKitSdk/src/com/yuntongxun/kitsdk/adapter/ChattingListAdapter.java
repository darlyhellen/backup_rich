...
public class ChattingListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        UserFaceManagerListener mListener=IMChattingHelper.getInstance().mUserListener;
        ...
        if(!item.getForm().equals("10000")){
	        if(mListener!=null){
	        		mListener.getUserFace(item,baseHolder.getChattingUser(),baseHolder.getChattingAvatar());
        }
        }else {
