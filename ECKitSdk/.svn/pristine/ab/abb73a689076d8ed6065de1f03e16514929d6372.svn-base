...
//                checkContact(message.getForm());??
     ...
     * 判断是否为同一条消息
     */
    public static boolean  isHaveSameMessage(ECMessage msg)
    {
    	String msgId=msg.getMsgId();
    	String sql="select  serverTime || '|' || msgid as kid from im_message where kid='"+msgId+"'";
