...
public class FileAccessor {
    ...
    public static final String APPS_ROOT_DIR = getExternalStorePath() + "/Keep_Health";
    public static final String EXPORT_DIR = getExternalStorePath() + "/Keep_Health/ECDemo_IM";
    public static final String CAMERA_PATH = getExternalStorePath() + "/DCIM/Keep_Health";
    public static final String TACK_PIC_PATH = getExternalStorePath()+ "/Keep_Health/.tempchat";
    public static final String IMESSAGE_VOICE = getExternalStorePath() + "/Keep_Health/voice";
    public static final String IMESSAGE_IMAGE = getExternalStorePath() + "/Keep_Health/image";
    public static final String IMESSAGE_AVATAR = getExternalStorePath() + "/Keep_Health/avatar";
    public static final String IMESSAGE_FILE = getExternalStorePath() + "/Keep_Health/file";
    ...
    /**
     * /data/data/com.Keep_Health.bluetooth/files
     *
     * @return
     */
    ...
    public static File getTackPicFilePath() {
        File localFile = new File(getExternalStorePath()+ "/Keep_Health/.tempchat" , "temp.jpg");
	 ...
	 * @param mBitmap
	 */
	public static void savePicToSD(Bitmap mBitmap ,String fileDir,String fileName) {
		...
		file.mkdirs();// 创建文件夹
		String filePath = fileDir + fileName;// 图片名字
		try {
