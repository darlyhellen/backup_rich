...
//                mDividerLinePaint);
    ...
    protected void highLightTextView(int position) {
        ...
        if (view instanceof TextView) {
            ((TextView) view).setTextColor(ResFinder.getColor("umeng_comm_text_topic_light_color"));
    ...
    @SuppressLint("NewApi") private TextView generateView(int index,String text) {
